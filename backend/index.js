...
app.post("/generate-paper", (req, res) => {
  ...
  if (subject) {
    filtered = filtered.filter(q => q.subject === subject ||  q.chapter === subject); // this will filter the subjects as per subject name and also in jee section chapter as subject name
  }
...
//   const { examLevel, subject, year } = req.body;
// const filtered = questions.filter(
//   q => q.examLevel === examLevel && q.chapter === subject && q.isPYQ && (!year || q.year === year)
// );
